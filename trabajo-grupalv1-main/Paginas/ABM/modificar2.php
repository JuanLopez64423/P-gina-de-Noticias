...
$sql="update noticias set noti_nombre='$noti_nombre', noti_descripcion='$noti_descripcion', noti_historia='$noti_historia', noti_imagenDeFondo1='$noti_imagenDeFondo1' where noti_id='$noti_id'";
...
<div style="font-family:arial; font-size:3vw;">
  ...
  echo "<br> <br> <br> <br> Se modifico la noticia correctamente.";
  ?>
  </div>
<br><br><br>
...
<?php
  ...
  ?>
   <div style="font-family:arial; font-size:3vw;">
<?php
echo"<br> No se pudo modificar la noticia.";
    ?>
    </div> 
