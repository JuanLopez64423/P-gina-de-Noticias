...
$sql="select *from noticias where noti_id='$noti_id';";
...
<div  class="infoNoticiasSql">
        ...
        <form>
                            ...
                            <p style=" display:inline;font-size:2vw; margin-left:1vw;" > <input style="border-radius:20px;" type="text" name="noti_nombre" value="<?php echo $registro['noti_nombre']; ?> "> :</p>
                            <p style="color:red; display:inline;font-size:1.8vw; " > <input style="color:red;border-radius:20px;width: 30vw;" type="text" name="noti_descripcion" value="<?php echo $registro['noti_descripcion']; ?>"></p>
                            <p style=" font-size:1.3vw; margin-left:1.3vw;" > <input style="width: 70%;border-radius:20px;" type="text" name="noti_historia" value="<?php echo $registro['noti_historia']; ?>"></p>
            </div>
...
<p>URL de la imagen: <input style="width: 40vw;height: 4vh;border-radius:20px;" type="text" name="noti_imagenDeFondo1" value="<?php echo $registro['noti_imagenDeFondo1']; ?>"> </p>

<br><br>
<input style="position:relative;left:30vw;color:white;background-color:blue;height: 6vh;width: 12vw;border-radius:20px;cursor:pointer;" type="submit" value="Modificar Noticia" formaction="modificar2.php"  formmethod="get" onClick="return confirm('¿Estas seguro de modificar esta noticia?' )">
